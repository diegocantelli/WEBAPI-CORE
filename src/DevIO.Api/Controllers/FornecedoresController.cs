...
namespace DevIO.Api.Controllers
{
    ...
    public class FornecedoresController : MainController
    {
        ...
        //Recebendo uma instância de Automapper via DI
        ...
        //AllowAnonymous -> Indica que este método não requer autenticação para ser acessado
        [AllowAnonymous]
        [HttpGet]
        public async Task<IEnumerable<FornecedorViewModel>> ObterTodos()
        {
            //Mapeando o retorno do repositório que é uma IEnumerable de uma model para um IEnumerable de ViewMOdel
